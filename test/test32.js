...
test( "Subclases", function( assert ) {
  ok( shapes[0] instanceof Shape, "Passed!" );
  ok( shapes[0] instanceof I_Shape , "Passed!" );
    
  ok( shapes[1] instanceof Shape, "Passed!" );
  ok( shapes[1] instanceof J_Shape , "Passed!" );    

  ok( shapes[2] instanceof Shape, "Passed!" );
  ok( shapes[2] instanceof L_Shape , "Passed!" );  
    
  ok( shapes[3] instanceof Shape, "Passed!" );
  ok( shapes[3] instanceof O_Shape , "Passed!" );    

  ok( shapes[4] instanceof Shape, "Passed!" );
  ok( shapes[4] instanceof S_Shape , "Passed!" );    

  ok( shapes[5] instanceof Shape, "Passed!" );
  ok( shapes[5] instanceof T_Shape , "Passed!" );    

  ok( shapes[6] instanceof Shape, "Passed!" );
  ok( shapes[6] instanceof Z_Shape , "Passed!" );    
});
